...
Airbrake.configure do |c|
  ...
  c.host = Rails.application.secrets.errbit_host
  c.project_id = 1
  c.project_key = Rails.application.secrets.errbit_key
...
Airbrake.add_filter do |notice|
  notice.ignore! if notice.stash[:exception].is_a?(Net::SMTPAuthenticationError)
end
