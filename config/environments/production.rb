...
Rails.application.configure do
  ...
  config.action_mailer.asset_host = "https://masters.mocintra.com/"
  ...
  config.action_controller.asset_host = "https://masters.mocintra.com/"
  ...
  # config.active_job.queue_name_prefix = "hr_module_#{Rails.env}"
  ...
  config.action_mailer.default_url_options = { :host => 'mm.mocintra.com' }
